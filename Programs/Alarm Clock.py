...
get_up = Label(clock, text="На какое время вы хотите поставить будильник",
    fg="Blue", bg="black", font=("Arial", 15, 'bold')).place(x=30, y=10)

time_format = Label(clock, text="Выберите время в 24-м формате",
    fg="Blue", bg="black", font=("Arial", 15, 'bold')).place(x=105, y=200)

addTime = Label(clock, text="Часы      Минуты    Секунды", font=60).place(x=135, y=90)
...
set_alarm = Button(clock, text="Поставить", fg="green", activebackground="grey", activeforeground="darkgreen", width=10, font=(
